...
public class EventDataBuilder {
	...
	public EventDataBuilder(String eventName, String externalId, Map<String, String> requestParam, DateTime dateTime) {
		callEvent = new IVRCallEvent(eventName, externalId, requestParam, DateUtil.now(), eventData);
	}
